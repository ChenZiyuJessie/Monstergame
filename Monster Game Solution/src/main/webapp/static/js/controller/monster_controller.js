...
var MonsterController = angular.module('MonsterController', []);

MonsterController.controller('MonsterController', [
		'$scope',
		'MonsterService','$window', 'bgcolor',
		function($scope, MonsterService,$window, bgcolor) {
			$scope.bgcolor = 'white';
			$scope.types = [
			...
			self.battle = function() {
				$scope.bgcolor = 'red';
				$window.location.href = '/monstergame/index2.jsp';
				$scope.battle = 1;
			};
